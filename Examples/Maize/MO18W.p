...
0.2	zh_factor, 7.19
3 1 2  ps_model, select photosynthesis model (1 = original C3, 2 = new C3, 3 = C4)
...
64.43 46.0 60.0 Vcmax25, maximum Rubisco activity at 25 C, umol m-2 s-1
525.85 58.0 Vpmax25, maximum PEP carbolylase activity at 25 C, umol m-2
...
0.303 0.211 0.185     	Gsref0, reference canopy stomatal conductance (mol m-2 s-1)
0.48 0.42 0.54    	m (proportion of Gsref0)
1 0  isAmphistomatous, (1 or 0) has stomata on both sides of leaf
-0.05   Md, used for diagnosing hydraulic model - if pressure goes higher than this value you get an error
-2.03 -1.0 -1.6 midday_at_sat_kl
4.22 4.38 2.56 e_at_saturated_kl
...
1.40 1.51 BD_(MG/m3)_soil_bulk_density
0.47  0.45 0.5 porosity
0.09 silt_fraction
0.17 clay_fraction
0.06 0.04 residual, residual water content m3 m-3
...
2.669 0.9 1.5 ax_Shoot-b_value_(weibull)
2.718 0.9 1.5 ax_Shoot-c_value_(weibull)
2.669 0.9 1.5 lat_Shoot-b_value_(weibull)
2.718 0.9 1.5 lat_Shoot-c_value_(weibull)
2.669 1.5 ax_Root-b_value_(weibull)
2.718 1.5 ax_Root-c_value_(weibull)
2.669 1.383 1.5 lat_Root-b_value_(weibull)
2.718 1.48 1.5 lat_Root-c_value_(weibull)
...
0.16 0.0800 0.03 kea, m3 d-1 gC-1 (for exudates)
0.75 0.3733 0.03 kes, m3 d-1 gC-1 (for exudates)
...
1.0 130000.0 2.0 Csapwood, kg ha-1
0.00120 0.0009 0.1 Croot_coarse_frac, dim
...
350.0 150000.0 SRL1, m gC-1 specific root length at root diameter of 250 um
0.000125 0.00025 0.000125 minRootDiam, m diameter of finest root
