...
64.56 46.0 60.0 Vcmax25, maximum Rubisco activity at 25 C, umol m-2 s-1
381.73 58.0 100.0 Vpmax25, maximum PEP carbolylase activity at 25 C, umol m-2
...
0.303 0.287 0.258   	Gsref0, reference canopy stomatal conductance (mol m-2 s-1)
...
-1.57 -1.2 -1.6 midday_at_sat_kl
4.22 4.31 3.0 e_at_saturated_kl
...
1.437 0.9 1.5 ax_Shoot-b_value_(weibull)
1.997 0.9 1.5 ax_Shoot-c_value_(weibull)
1.437 0.9 1.5 lat_Shoot-b_value_(weibull)
1.997 0.9 1.5 lat_Shoot-c_value_(weibull)
1.437 1.5 ax_Root-b_value_(weibull)
1.997 1.5 ax_Root-c_value_(weibull)
1.437 1.383 1.5 lat_Root-b_value_(weibull)
1.997 1.48 1.5 lat_Root-c_value_(weibull)
...
182  dayToStopMaizeRefilling, used when both usePhenology and useLeafModule are set to zero (false)
0 useLeafModule
