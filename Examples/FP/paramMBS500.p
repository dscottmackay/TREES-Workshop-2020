...
0.45 3.5	z_ref, m 
0.065 0.06 2.0	lai, single sided
0.3 2.0	canopy_height, m
1.5 4.5	lai_at_full_canopy_height
...
3.0 1.85 3.27    Jmax_mult, ratio of Jmax to Vcmax
...
0.15 0.303 0.215    	Gsref0, reference canopy stomatal conductance (mol m-2 s-1)
...
-0.5 -1.6 midday_at_sat_kl
3.5 2.5 4.22 e_at_saturated_kl
...
0.35 0.47 0.5 porosity
0.3 0.09 silt_fraction
0.2 0.17 clay_fraction
0.25 0.06 residual, residual water content m3 m-3
...
1.0 initial_conductivity(root), used to set saturated K's
0.01 decrement(root)- default 0.001
2.0 initial_conductivity(shoot), used to set saturated K's
0.01 decrement(shoot)
0.22 0.05 theta_opt
30.0 25.0 optimal_soil_T
...
0.000001 0.021 Croot_frac, dim
1.00 13710.0 29460.0 Cstem, kg ha-1
10.0 2.0 Csapwood, kg ha-1
0.000005 0.00216 0.1 Croot_coarse_frac, dim
...
400.0 400.0 60.0 SLA, m2 kgC-1 leaf
946.0 1454.0 550.0 SRL1, m gC-1 specific root length at root diameter of 250 um
0.00006 0.000125 0.000250 minRootDiam, m diameter of finest root
0.0010 0.064 maxRootDiam, m diameter of thickest root
0.25 0.333 0.04 minRootLifespan, years, lifespan of finest root at lowest C:N ratio
...
0.01 0.10 0.01 leafNSCscalar (proportion of leaf structural carbon)
0 usePhenology
99999999999.0 leafLife Span
10 max_iteration(the_max_number_of_iterations_to_achieve_convergence_Delta<THR
500 4 10.0 microbiomeScalar, unitless, multiplier for the initial nutrient status of microbiome
...
0 0 1 forceRefilling, currently set internally in code when needed
