...
0.45 3.5	z_ref, m 
0.065 0.3 2.0	lai, single sided//MCH
0.3 2.0	canopy_height, m
1.5 1.0 4.5	lai_at_full_canopy_height//MCH
...
3.0  2.7 1.85   Jmax_mult, ratio of Jmax to Vcmax
...
0.38 0.38 0.38 alphaSmax, fraction of glycolate carbon diverted to serine during photorespiration//MCH
0.0 1.5 1.5 Nmax, maximum rate of de novo nitrogen supply to the chloroplast, umol N m-2 s-1//MCH
0.15 0.40 0.303     	Gsref0, reference canopy stomatal conductance (mol m-2 s-1)
...
-0.5 -0.9 -1.6 midday_at_sat_kl//MCH
3.5 4.0 2.5 e_at_saturated_kl//MCH
...
0.1 0.07 residual, residual water content m3 m-3//MCH
...
-0.2 -0.25 0.05  pd_at_sat_kl//MCH
...
1.0 3.0 initial_conductivity(root), used to set saturated K's//MCH
0.01 decrement(root)- default 0.001
2.0 6.0 initial_conductivity(shoot), used to set saturated K's//MCH
0.01 0.02 decrement(shoot)//MCH
...
0.0085 0.00425 0.004256 kd, d-1
0.60 0.6 kn, m3 d-1 gC-1
0 0.0800 0.2 kea, m3 d-1 gC-1 (for exudates) amino acid
0 0.3733 0.6 kes, m3 d-1 gC-1 (for exudates) sugar
0.000065 0.00001625 0.000065 kl, m3 d-1 gC-1
0.0000025 0.0000025 kh, m3 d-1 gC-1
13 fr_minCN, minimum fine root C:N ratio
22 fr_maxCN, maximum fine root C:N ratio
13 leaf_minCN, minimum leaf C:N ratio
22 leaf_maxCN, maximum leaf C:N ratio
79200.0 214000.0 19782.4 Cbelowground, kg ha-1
0.000027 0.00001 0.0152229  Clitter_frac, dim
0.00001 0.00006 0.000240 Croot_frac, dim//
1.00 13710.0 29460.0 Cstem, kg ha-1
10.0 2.0 Csapwood, kg ha-1
0.00001 0.00006 0.000240 Croot_coarse_frac, dim//MCH
...
946.0 1454.0 1454.0 SRL1, m gC-1 specific root length at root diameter of 250 um//MCH
0.00006 0.000125 0.000125 minRootDiam, m diameter of finest root//MCH
0.0010 0.0030 0.064 maxRootDiam, m diameter of thickest root//MCH
0.25 0.2 0.04 minRootLifespan, years, lifespan of finest root at lowest C:N ratio//MCH
...
0.01 0.10 0.1 leafNSCscalar (proportion of leaf structural carbon)//MCH
0 usePhenology
99999999999.0 leafLife Span
10 max_iteration(the_max_number_of_iterations_to_achieve_convergence_Delta<THR
500 83.3 10.0 microbiomeScalar, unitless, multiplier for the initial nutrient status of microbiome//MCH
...
30.0 14.0 60.0 SLA_min //SLA_min MCH
